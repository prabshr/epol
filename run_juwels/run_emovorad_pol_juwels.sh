...
EXECUTABLE=${HOME}/emvorado-offline/build_juwels/cosmo_refl_offline_master_par_rcl-intel.exe
...
#SBATCH --job-name=${jobname_in_queue}
#SBATCH --nodes=${nnode} 
#SBATCH --ntasks=${nproc}
#SBATCH --output=log-out.%j
#SBATCH --error=err-out.%j
#SBATCH --time=${maxcputime}
#SBATCH --partition=${jobclass}
#SBATCH --account=terrsysmp-art
